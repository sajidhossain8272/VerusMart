      ...
      <div className="bg-white rounded-[20px] shadow-[0_10px_25px_rgba(0,0,0,0.1)] w-full max-w-[420px] p-[40px_30px] flex flex-col items-center">
        ...
        <form action="/api/auth/login" method="POST" className="w-full flex flex-col gap-[20px]">
          ...
          <div className="relative">
            ...
            <span className="absolute right-[15px] top-[14px] text-gray-400 cursor-pointer hover:text-[#00bcd4]" id="togglePassword"><i className="fa-solid fa-eye-slash"></i></span>
          </div>

          <button type="submit" className="w-full h-[48px] bg-[#ac3255] text-white border-none rounded-[10px] font-bold text-[16px] cursor-pointer mt-[10px] transition-all hover:bg-[#8b2844] hover:-translate-y-[2px] shadow-[0_4px_10px_rgba(172,50,85,0.3)]">Login</button>

        </form>

        <p className="mt-[25px] text-[14px] text-gray-500">
          Don't have an account? <Link href="/register" className="text-[#00bcd4] font-bold hover:underline">Sign up</Link>
        </p>
