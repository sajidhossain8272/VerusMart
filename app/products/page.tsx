  ...
  try {
    ...
    return (
      <div className="w-[92%] max-w-[1240px] mx-auto py-12 text-center">
        <h1 className="text-2xl font-black text-[#002b5b] mb-4">Our Products</h1>
        <p className="text-gray-500 text-sm mb-6">Discover great authentic items at Verus Mart.</p>
        <Link href="/" className="bg-[#f85606] text-white font-bold py-2.5 px-6 rounded-xl">
          Return Home
        </Link>
      </div>
    )
